...
#define IRQ_SCK		RCC_APB2Periph_GPIOA
#define MISO_SCK	RCC_APB2Periph_GPIOB
#define MOSI_SCK	RCC_APB2Periph_GPIOB
#define SCK_SCK		RCC_APB2Periph_GPIOB
#define CSN_SCK		RCC_APB2Periph_GPIOC
#define CE_SCK		RCC_APB2Periph_GPIOC
